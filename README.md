...
- 🌱 Estudiando **Python** e **IA Generativa**.
- 🏢 Experiencia previa en **NTT Data** (Proyecto Caixabank).
...
### ⛩️ Intereses & Bonustrack
Cuando no estoy programando, me encontrarás:
- 🗾 Explorando la cultura de **Japón** y el **Anime**.
- 🎮 Disfrutando de los **videojuegos**.
- 🎬 Disfrutando de buen **cine**.

---

### 📫 Conecta conmigo:
- 💼 [LinkedIn](https://linkedin.com/in/xavi-boniquet)
- 📧 [xavi.boniquet@gmail.com](mailto:xavi.boniquet@gmail.com)
